    ...
    for page in range(9, 10):
        ...
        for pi in products_items:
            ...
            if product_data_sale is None:
                ...
                # ---------------Product price
                dict_param_div = {22: 16, 23: 14, 25: 16}

                for k, v in dict_param_div.items():
                    try:
                        if len(product_data) == k:
                            product_price = product_data[v].find('div', class_="relative mt-1 w-full").find('span',
